...
module.exports = function(options) {
  ...
  app.put("/:bucket/:key(*)", middleware.bucketExists,upload.single("file"), middleware.putObject );
  ...
  app.post("/:bucket", middleware.bucketExists, upload.single("file"), middleware.putObject);
